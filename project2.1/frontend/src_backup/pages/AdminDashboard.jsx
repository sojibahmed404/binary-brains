...
const ROLE_COLORS = {
  ...
  DONOR:    'bg-indigo-100 text-indigo-700 border-indigo-200',
    ...
    <div className="max-w-7xl mx-auto animate-fade-in">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-4">
          <p className="text-sm font-medium text-gray-500 hidden sm:flex items-center gap-2">
            <FiCheckCircle className="text-gray-400" /> {today}
          </p>
          <button onClick={() => { loadStats(); loadUsers(); loadDonors(); }} 
            className="flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 transition-colors shadow-sm text-sm font-medium">
            <FiRefreshCw /> Refresh
          </button>
        </div>
      </div>
        ...
        <div className="flex border-b border-gray-200 bg-gray-50/50">
          <button
            ...
            className={`flex-1 py-4 text-sm font-semibold flex items-center justify-center gap-2 transition-colors
              ${activeTab === 'users' ? 'text-[#5a67d8] bg-white border-b-2 border-[#5a67d8]' : 'text-gray-500 hover:text-gray-700'}`}
          >
          ...
          <button
            ...
            className={`flex-1 py-4 text-sm font-semibold flex items-center justify-center gap-2 transition-colors
              ${activeTab === 'donors' ? 'text-[#5a67d8] bg-white border-b-2 border-[#5a67d8]' : 'text-gray-500 hover:text-gray-700'}`}
          >
                    ...
                    <tr key={d.id} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        {d.availability 
                          ...
                          : <span className="flex items-center gap-1 text-gray-400"><FiXCircle /> No</span>
                        }
                      </td>
                    </tr>
                  ))}
