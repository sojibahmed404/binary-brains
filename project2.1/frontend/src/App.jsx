  ...
  return (
    <DashboardLayout>
      <Routes>
        ...
        <Route path="/register" element={<Navigate to="/add-donor" replace />} />
        ...
        <Route path="*" element={
          <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center bg-white rounded-2xl border border-gray-200 shadow-sm">
            <div className="text-8xl font-heading font-black text-red-500/20 mb-4">404</div>
            <h2 className="font-heading font-bold text-2xl text-gray-800 mb-2">Page Not Found</h2>
            <p className="text-gray-500 mb-6">The page you're looking for doesn't exist.</p>
            <a href="/" className="px-6 py-2.5 bg-red-500 text-white font-medium rounded-lg hover:bg-red-600 transition-colors">← Go Home</a>
          </div>
        } />
      </Routes>
    </DashboardLayout>
